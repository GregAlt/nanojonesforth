...
HIDE KEY
:04 KEY KEY_CURRKEY @ KEY_BUFFTOP @ SWAP 1+ < 0BRANCH 70o KEY_BUFFER KEY_CURRKEY ! KEY_BUFFER_SIZE 
    KEY_BUFFER G0 SYS_READ SYSCALL3 DUP G1 < 0BRANCH 44o DROP CALL_SYS_EXIT EXIT KEY_BUFFER + 
    KEY_BUFFTOP ! G0 0BRANCH 01o KEY_CURRKEY @ C@ KEY_CURRKEY @ 1+ KEY_CURRKEY ! EXIT 00;

:04 WORD G0 DROP KEY DUP G92 - 0= 0BRANCH 51o DROP KEY DUP G10 - 0= 0BRANCH 31o DUP G32 SWAP < 
    0BRANCH 13o WB SWAP WB SWAP SWAP C! 1+ DUP KEY DUP G32 1+ < 0BRANCH 26o DROP DROP WB - WB SWAP 
    EXIT 00;
...
\ a helper for NUMBER
:04 DIGIT_FROM_CHAR DUP G58 < 0BRANCH 43o G48 - DUP G64 SWAP < 0BRANCH 43o G55 - DUP DUP BASE @ 
    SWAP - SWAP 1+ * G1 < 0= SWAP EXIT 00;

\ NUMBER for actual number parsing with arbitrary bases
:04 NUMBER NUMBER_CURLEN ! NUMBER_CURADDR ! G0 NUMBER_CURSUM ! G0 NUMBER_CURLEN @ 0BRANCH 65o 
    NUMBER_CURADDR @ C@ G45 - 0= 0BRANCH 55o 1+ NUMBER_CURADDR @ 1+ NUMBER_CURADDR ! NUMBER_CURLEN 
    @ G1 - NUMBER_CURLEN ! NUMBER_CURLEN @ 0BRANCH 77o NUMBER_CURSUM @ BASE @ * NUMBER_CURSUM ! 
    NUMBER_CURADDR @ C@ G1 NUMBER_CURADDR +! DIGIT_FROM_CHAR NUMBER_CURSUM @ + NUMBER_CURSUM ! 
    NUMBER_CURLEN @ G1 - DUP NUMBER_CURLEN ! * 0= 0BRANCH 03o 0BRANCH 47o G0 NUMBER_CURSUM @ - 
...
:04 INTERPRET_ERROR INTERPRET_ERRMSGLEN @ INTERPRET_ERRMSG @ G2 SYS_WRITE SYSCALL3 DROP
    KEY_CURRKEY @ KEY_BUFFER - DUP KEY_BUFFER + SWAP DUP G40 SWAP G40 SWAP < 0BRANCH 42o
    SWAP DROP 2DUP - G2 SYS_WRITE SYSCALL3 DROP G1 INTERPRET_ERRMSGNL @ G2 SYS_WRITE 
    SYSCALL3 DROP EXIT 00;

:04 INTERPRET WORD 2DUP G0 INTERPRET_IS_LIT ! FIND DUP 0BRANCH 65o SWAP DROP SWAP DROP DUP 1+ 1+ 
    1+ 1+ C@ SWAP >CFA SWAP F_IMMED NAND DUP NAND G0 0BRANCH 56o INTERPRET_IS_LIT @ 1+ 
    INTERPRET_IS_LIT ! DROP NUMBER 0BRANCH 44o DROP INTERPRET_ERROR EXIT G0 0= STATE @ * G1 SWAP 
    - 0BRANCH 55o INTERPRET_IS_LIT @ 0= 0BRANCH 45o EXECUTE G0 0BRANCH 41o G0 0BRANCH 51o 
    INTERPRET_IS_LIT @ 0BRANCH 44o ' LIT , , EXIT 00;
...
HIDE \
HIDE HIDE
:04 QUIT R0 RSP! INTERPRET G0 0BRANCH 35o 00;
QUIT
